...
O board do time é [Board](https://www.atlassian.com/br/software/jira), lá você pode acompanhar e abrir alguma demanda nova.

Temos o canal de sustentação [sds-sustentação](https://slack.com/intl/pt-br)

<details>
  <summary>Descrição dos campos</summary>

```bash
	"external_id": str,				# An identifier used by third party services
```
</details>
